...
\begin{titlepage}
    \begin{center}
        ...
        {\LARGE \textbf{Plateforme Umuhuza de Location et Vente}}
...
\textbf{Umuhuza} est une plateforme moderne développée pour faciliter les acheteurs immobilières et automobiles au Burundi. Le projet vise à éliminer les intermédiaires, réduire les fraudes, et offrir une expérience sécurisée pour les acheteurs et vendeurs.
...
\textbf{Mots-clés:} Immobilier, Véhicules, Django, React, PostgreSQL, API REST, JWT, E-commerce, Burundi
...
Concevoir et développer \textbf{Umuhuza}, une plateforme web moderne Umuhuza dédiée à la location et à la vente d'immobilier et de véhicules au Burundi, offrant un environnement sécurisé, transparent et efficace pour les transactions.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Peuvent créer des annonces illimitées selon son bouquet 
...
\hline
F09 & Paiements & Intégration Lumicash, achat plans premium, historique paiements \\
\hline
